...
// - Dare la possibilità all’utente attraverso 3 prompt di aggiungere un nuovo oggetto studente inserendo nell’ordine: nome, cognome e età. (con aggiunta di cose non richieste per esercitarmi)


$(document).ready(function(){


    $('#stampa').append('<h1>Apri la console del tuo browser prima di premere il pulsante che apparirà tra poco qui sotto!</h1>' + '<button>Cliccami</button>');
